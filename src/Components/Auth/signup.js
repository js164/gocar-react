...
import { desetAdmin, desetAuth, setAuth ,setAlertShow } from '../../ReduxStore/Action';
        ...
        return (
            <div className='container'>
                ...
                <Form onSubmit={this.Signup}>
                    ...
                    <Link to="/adminSignup" className='m-2'>Sign up as Admin</Link>
                </Form>
                <br /><br />
                <hr /><hr />
            <button style={
...
export default function (props) {
    ...
    return <SignUp {...props} navigate={navigate} dispatch={dispatch} />;
}